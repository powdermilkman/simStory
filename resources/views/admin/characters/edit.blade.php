            ...
            <div x-data="{ isAlien: {{ $character->is_alien ? 'true' : 'false' }} }" class="mb-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div x-show="isAlien">
                    ...
                    <select name="alien_style" id="alien_style"
                        ...
                        <option value="lomtrian"   {{ old('alien_style', $character->alien_style) === 'lomtrian'   ? 'selected' : '' }}>Lomtrian</option>
                        <option value="stray"      {{ old('alien_style', $character->alien_style) === 'stray'      ? 'selected' : '' }}>Stray</option>
                    </select>
                </div>
            </div>
