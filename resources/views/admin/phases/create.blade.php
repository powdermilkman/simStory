<x-admin-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Create Phase</h2>
    </x-slot>

    <form action="{{ route('admin.phases.store') }}" method="POST" x-data="phaseForm()">
        @csrf
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required
                                placeholder="e.g., Act 1: Introduction"
                        ...
                        <div>
                            ...
                            <select name="parent_phase_id" id="parent_phase_id"
                                ...
                                @foreach($parentPhases as $parent)
                                    <option value="{{ $parent->id }}" {{ old('parent_phase_id') == $parent->id ? 'selected' : '' }}>
                                        {{ $parent->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="mt-4 flex gap-6">
                        ...
                        <label class="flex items-center">
                            <input type="checkbox" name="requires_all_sibling_phases" value="1" {{ old('requires_all_sibling_phases') ? 'checked' : '' }}
                                class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring-blue-500">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-blue-50 rounded-lg p-6">
                    ...
                    <ul class="text-sm text-blue-800 space-y-2">
                        <li>All conditions must be met for the phase to complete</li>
                        <li>Actions execute in order when the phase completes</li>
                        <li>Use "requires all sibling phases" for sequential progression</li>
                        <li>Child phases unlock after their parent completes</li>
                    </ul>
                </div>
            </div>
        </div>
